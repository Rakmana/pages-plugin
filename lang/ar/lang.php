...
return [
    ...
    'page' => [
        ...
        'layout' => 'تخطيط',
        'layouts_not_found' => 'لا يوجد تخطيطات',
        'saved' => 'The page has been successfully saved.',
        'tab' => 'صفحات',
        'manage_pages' => 'إدارة الصفحات الثابتة',
        'manage_menus' => 'إدارة القوائم الثابتة',
        'access_snippets' => 'قصاصات الدخول',
        'manage_content' => 'إدارة المحتويات الثابتة',
    ],
    'menu' => [
        'menu_label' => 'Menus',
